      ...
      <header className="bg-white shadow-sm relative z-10">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-display font-bold text-amethyst-600">
              Admin Dashboard
            </h1>
            <div className="flex items-center gap-4">
              ...
              <a
                ...
                className="flex items-center gap-2 px-4 py-2 text-gray-700 bg-gray-100 hover:bg-amethyst-100 hover:text-amethyst-700 rounded-lg transition-all cursor-pointer font-medium"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="card p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="w-12 h-12 bg-amethyst-100 rounded-lg flex items-center justify-center">
                <FiPackage className="w-6 h-6 text-amethyst-600" />
              </div>
            </div>
          </div>
        ...
        <div className="flex space-x-4 mb-6 border-b border-gray-200">
          <button
            ...
            className={`pb-4 px-4 font-semibold transition-colors ${
              activeTab === 'products'
                ? 'text-amethyst-600 border-b-2 border-amethyst-600'
